import { GridItem, Flex, Text, Image, useDisclosure, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody, Avatar, Divider, VStack, Button } from "@chakra-ui/react"
...
function ProfilePost({post}) {
    ...
    const handleDeletePost = async() => {
        if(!window.confirm("Are you confirm you want to delete this post? ")) return
        ...
        <ModalContent>
            ...
            <ModalBody bg={"black"} pb={5}>
                ...
                <Flex alignItems={"center"} gap={4}>
                    ...
                    <Avatar src={userProfile.profilePicURL} size={"sm"} name="Hani Rawat" />
